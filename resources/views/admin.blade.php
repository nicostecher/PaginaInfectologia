      ...
      <div class="cajita">
        ...
        <div class="comisiones">  
          <ul>
              ...
              <li><a href="/listadoCasosClinicos"><button type="button" class="btn btn-info">Casos Clínicos</button></a></li>
              ...
              <li><a href="/listadoSitios"><button type="button" class="btn btn-info">Sitios de Interés</button></a></li>
              <li><a href="/listadoBibliografias"><button type="button" class="btn btn-info">Bibliografías</button></a></li>
